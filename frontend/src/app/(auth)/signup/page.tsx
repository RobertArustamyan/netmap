...
export default function SignupPage() {
  ...
  if (verificationSent) {
    return (
      <div style={{ background: bg, minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "var(--font-sans)" }}>
        <div style={{ maxWidth: 480, textAlign: "center", padding: 40 }}>
          <Link href="/" style={{ display: "inline-flex", alignItems: "center", gap: 10, textDecoration: "none", color: ink, marginBottom: 48 }}>
          ...
          <h1 style={{ fontSize: 56, lineHeight: 1.02, letterSpacing: "-0.03em", fontWeight: 700, margin: "0 0 18px" }}>
            One step{" "}
            <span style={{ ...serifStyle, color: accent }}>left</span>
          </h1>
          <p style={{ fontSize: 16, color: muted, lineHeight: 1.6, marginBottom: 32 }}>
            We sent a verification link to{" "}
            <strong style={{ color: ink }}>{email}</strong>. Click it to activate your account and start mapping.
          </p>
          <Link href="/login" style={{ fontSize: 14, fontWeight: 600, color: ink, textDecoration: "none", borderBottom: `1px solid ${rule}`, paddingBottom: 2 }}>
            Back to sign in →
          </Link>
        </div>
      </div>
  ...
  return (
    ...
    >
      <div style={{ flex: 1, padding: "40px 56px", display: "flex", flexDirection: "column" }}>
        {/* Logo */}
        <Link href="/" style={{ display: "flex", alignItems: "center", gap: 10, color: ink, textDecoration: "none" }}>
          <svg width="26" height="26" viewBox="0 0 32 32" fill="none">
            <line x1="9" y1="9" x2="23" y2="9" stroke="#94a3b8" strokeWidth="1.75" strokeLinecap="round" />
            <line x1="9" y1="9" x2="16" y2="23" stroke="#94a3b8" strokeWidth="1.75" strokeLinecap="round" />
            <line x1="23" y1="9" x2="16" y2="23" stroke="#94a3b8" strokeWidth="1.75" strokeLinecap="round" />
        ...
        >
          ...
          >
            Create an{" "}
            <span style={{ ...serifStyle, color: accent }}>account</span>
          </h1>
          ...
          <div style={{ display: "flex", gap: 10, marginBottom: 22 }}>
            <button
              ...
              style={{ flex: 1, padding: "10px 12px", borderRadius: 8, border: `1px solid ${rule}`, background: "white", fontSize: 13, fontWeight: 500, color: ink, cursor: oauthLoading ? "not-allowed" : "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8, fontFamily: "inherit", opacity: oauthLoading && oauthLoading !== "google" ? 0.5 : 1 }}
            >
            ...
            <button
              ...
              disabled={!!oauthLoading}
              style={{ flex: 1, padding: "10px 12px", borderRadius: 8, border: `1px solid ${rule}`, background: "white", fontSize: 13, fontWeight: 500, color: ink, cursor: oauthLoading ? "not-allowed" : "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8, fontFamily: "inherit", opacity: oauthLoading && oauthLoading !== "github" ? 0.5 : 1 }}
            >
            ...
            <button
              type="button"
              style={{ flex: 1, padding: "10px 12px", borderRadius: 8, border: `1px solid ${rule}`, background: "white", fontSize: 13, fontWeight: 500, color: ink, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8, fontFamily: "inherit" }}
            >
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            <label style={{ display: "flex", flexDirection: "column", gap: 6 }}>
              ...
              <input
                ...
                style={{ appearance: "none", padding: "11px 14px", borderRadius: 8, border: `1px solid ${rule}`, background: "white", fontSize: 14, fontFamily: "inherit", color: ink, outline: "none" }}
              />
            </label>
            ...
            {/* Confirm password */}
            <label style={{ display: "flex", flexDirection: "column", gap: 6 }}>
              <span style={{ fontSize: 12, fontWeight: 600, color: ink }}>Confirm password</span>
              <input
                type="password"
            ...
            >
              {loading ? (
                <img src="/loaders/netmap-loader.svg" alt="Creating account" style={{ width: 24, height: 24 }} />
              ) : (
                "Create account →"
              )}
            </button>
          ...
          <p style={{ marginTop: 20, fontSize: 13, color: muted, textAlign: "center" }}>
            ...
            <Link href="/login" style={{ color: ink, fontWeight: 600, textDecoration: "none" }}>
              Sign in
            </Link>
          </p>
        </div>
